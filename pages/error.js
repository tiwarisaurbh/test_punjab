...
export default function Error() {
    return (
        ...
        />
                        ...
                        <div className="text-center">
                            <p className="mb-0 text-slate-400 font-medium">© {(new Date().getFullYear())}{" "} @ We will try <i className="mdi mdi-heart text-red-600"></i> by <Link to="/httpsreethemes.in/" target="_blank" className="text-reset">Shreethemes</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
