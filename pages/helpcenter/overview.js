            ...
            <section className="relative md:py-24 py-16">
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        ...
                        <p className="text-slate-400 max-w-xl mx-auto">We are a bustling marketplace dedicated to bringing together exceptional artists from Punjab with their fans and collectors of unique tokens, celebrating the cultural richness and diversity of the region!</p>
                    </div>
