                        ...
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="md:flex items-center p-6 shadow dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900">
                                ...
                                <div className="md:ms-4 md:mt-0 mt-6">
                                    ...
                                    <div className="mt-2">
                                        <span className="text-slate-400 font-medium me-2 inline-flex items-center"><HiOutlineOfficeBuilding className="text-[18px] text-emerald-600 me-1"/>{data?.title ? `${data?.title} pvt. ltd ` : "Lenovo pvt. ltd"}  .</span>
